...
class ScpLazyDict(object):
    ...
    def __getitem__(self, item):
        # TODO: check if this is ok without python2 decode
        # return read_mat(self.loader_dict[item.decode('utf-8')])
        return read_mat(self.loader_dict[item])
...
def read_dict_scp(file_or_fd):
    ...
    try:
        for line in fd:
            ...
            key, rxfile = str(line, 'utf-8').split(' ')
            d[key] = rxfile
    finally:
