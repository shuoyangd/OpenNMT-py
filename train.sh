...
NAME=model.$DATA_TYPE.hdim.$RNN_SIZE.dl.$DEC_LAYERS.aug.$AUG_TYPE.$TRAIN_WITH_AUG.n.$ADD_NOISE.hc.$HIGHWAY_CONCAT.drop.$DROPOUT.arch.$ARCH.sub.$SUBSAMPLE.wtn.$WEIGHT_NORM.gn.$MAX_GRAD_NORM.atn.$ATTN
echo $NAME
